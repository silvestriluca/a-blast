/**
 * Class based version of thee.js LegacyJSONLoader
 * @author Luca Silvestri / https://github.com/silvestriluca
 * Original code by:
 * @author mrdoob / http://mrdoob.com/
 * @author alteredq / http://alteredqualia.com/
 */

THREE.LegacyJSONLoader = class LegacyJSONLoader extends THREE.Loader {
	constructor(manager) {
		super(manager);
	...
	parse() {
		...
		return function localParse(json, path) {
